...
func (s *ACFDetectionParamState) NewState(ctx *core.Context, with tuple.Map) (core.SharedState, error) {
	p, err := with.Get("file")
	if err != nil {
		return nil, err
	}
...
func (s *ACFDetectionParamState) Write(ctx *core.Context, t *tuple.Tuple) error {
	return nil
}
